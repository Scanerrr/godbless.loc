...
class FRONTEND_EDIT_PROFILE
{
    ...
    public function registration_url($url)
    {
    ...
    // update process
    public function update_process_form($atts)
    {
        global $wpdb;
        ...
        $output = '<div id="fep-message" class="validation-' . $style . '">'.$message.'</div>';
...
//        include_once realpath(dirname(__FILE__)).'/login_form.php';
    ...
    // login action
    public function basic_form($atts)
    {
